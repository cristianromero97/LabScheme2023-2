...
;indicado, el scrips de pruebas y ejemplos se encuentran en un archivo por separado, el archivo main hace llamado de los demas para trabajar
;vease este archivo como el archivo general en donde esta escrito todo el programa).....
;------------------------------------------------------------------------------------------------------------------------
